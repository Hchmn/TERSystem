  ...
  <link href="{{ asset('images') }}">
    ...
    <div class="container float-right place-content-center h-full  opacity-100 w-1/4 h-full flex items-center justify-center"  style="">
            ...
            <form action="/login" method="POST" class=" py-5 px-5 h-auto w-auto rounded-lg mt-5 mr-5 border">
              @csrf
            <h1 class=" block w-full text-3xl	 font-sans md:font-serif text-center text-blue-100 mb-5 font-black mt-5">Teacher's Efficiency Rating (For Students)</h1>
                ...
                @endif
                <p class="text-xl font-sans md:font-serif text-right text-blue-100 mt-5 font-black">Are you a teacher? Sign in <a href="teacher_login" class=" text-blue-800 mt-5 underline underline-offset-4">Here</a></p>
                <button class="mt-4 py-2 px-3 text-xl border  block justify-center font-sans md:font-serif bg-blue-700 rounded-lg w-auto text-blue-100 text-center justify-center font-black	" type="submit">Submit</button>
            </form>
    </div>
