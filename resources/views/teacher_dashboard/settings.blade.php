...
<body class="h-full w-full">
    <div class="container w-80 border h-full">
        ...
        <a href="teacher_settings"class="flex  w-full h-auto bg-sky-300 hover:bg-sky-700 px-2 py-2 hover:text-blue-100 border text-xl font-sans md:font-serif text-black-100 font-black">Settings</a>
