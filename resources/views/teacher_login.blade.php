...
<head>
    ...
    <div class="md:container md:mx-auto place-content-center h-full   opacity-100 w-1/4 h-full flex items-center justify-center"  style="">
            ...
            <form action="login" method="POST" class=" py-5 px-5 h-auto w-auto rounded-lg border-4">
              @csrf
            <h1 class=" block w-full text-3xl font-sans md:font-serif text-center text-white mb-5 mt-5">Teacher's Efficiency Rating  (Teachers)</h1>
                <input type="hidden" value = "1" name="type">
                <label for="username" name="" class="block w-full text-2xl font-sans md:font-serif text-center text-white " > Username</label>
                ...
                @endif
                <label for="password" name="" class="block w-full text-2xl font-sans md:font-serif text-center text-white mt-5">Password</label>
                ...
                @if(Session::has('FN'))
                    {{Session::flush()}}
                @endif
                <p class="text-xl font-sans md:font-serif text-right text-white mt-5 ">Are you a student? Sign in <a href="/" class=" text-white mt-5 underline underline-offset-4">Here</a></p>
                <button type="submit" class="mt-4 py-2 border px-3 text-xl block justify-center font-sans md:font-serif bg-blue-700 rounded-lg w-auto text-blue-100 text-center justify-center">Submit</button>
            </form>
    </div>
